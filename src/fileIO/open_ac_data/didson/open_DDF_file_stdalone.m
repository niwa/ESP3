...
if ~isequal(Filename_cell, 0)
    ...
    for uu = 1:nb_files
        ...
        ac_data_temp.init_sub_data('img_intensity','DefaultValue',0);
        iframe = 0;
...
%             end
            ...
            ac_data_temp.replace_sub_data_v2(permute(frame,[1 3 2]),'img_intensity','idx_ping',iframe);
            %ac_data_temp.replace_sub_data_v2(db2pow(frame),'power','idx_ping',iframe);
