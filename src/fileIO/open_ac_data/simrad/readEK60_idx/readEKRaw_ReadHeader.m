...
switch dgType
    case 'CON0'
        ...
        for ic = 1:configheader.transceivercount
            configXcvr(ic) = readEKRaw_ReadTransceiverConfig(fid);
            frequencies(ic) = configXcvr(ic).frequency;
            channels{ic}= deblank(configXcvr(ic).channelid);
        end
