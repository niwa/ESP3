function [snaps,types,strat,trans,regs,cells,opts_cell]=merge_survey_input_for_integration(surv_in_obj,varargin)

p = inputParser;
addRequired(p,'surv_in_obj',@(obj) isa(obj,'survey_input_cl'));
parse(p,surv_in_obj,varargin{:});

[snap_vec,type_vec,strat_vec,trans_vec,~,~,regs_cell,cells_cell,opts_cell]=list_transects(surv_in_obj);
