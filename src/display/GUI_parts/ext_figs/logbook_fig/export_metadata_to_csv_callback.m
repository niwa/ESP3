function export_metadata_to_csv_callback(~,~,path_f)
...
struct_out = struct('Filename','','Snapshot',0,'Type','','Stratum','','Transect',0,'StartTime',0,'EndTime',1,'Comment','');
...
open_txt_file(fullfile(pathname,filename));
