function export_metadata_to_html_callback(~,~,path_f)
...
fname  = [surv_data_struct.Voyage{1} '_' surv_data_struct.SurveyName{1} '_logbook.html'];

filename=generate_valid_filename([surv_data_struct.Voyage{1} '_' surv_data_struct.SurveyName{1} '_logbook.html']);
