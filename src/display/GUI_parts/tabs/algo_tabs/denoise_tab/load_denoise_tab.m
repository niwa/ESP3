...
denoise_tab_comp.filtering_panel=uipanel(denoise_tab,'title','Notch Filtering (FM)','Units','Pixels','Position',[t.container.Position(1)+t.container.Position(3) 0 4*l h]);
...
denoise_tab_comp.table_notch_filter.ContextMenu =rc_menu;
...
function rm_bands_cback(~,~,tb,main_figure)
...
function edit_band_stop_cback(~,~,main_figure)
...
function apply_notch_filtering(~,~,main_figure,act)
