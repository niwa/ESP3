...
uicontrol(display_tab_comp.top_button_group,gui_fmt.txtStyle,'String','C-Max','Position',pos{2,second_group_start+ii}{1});
uicontrol(display_tab_comp.top_button_group,gui_fmt.txtStyle,'String','C-Min','Position',pos{1,second_group_start+ii}{1});
%uicontrol(display_tab_comp.top_button_group,gui_fmt.txtStyle,'String','Min','Position',[540 85 60 30],'Fontweight','bold');

display_tab_comp.caxis_down=uicontrol(display_tab_comp.top_button_group,gui_fmt.edtStyle,'position',pos{1,second_group_start+ii}{2},'string',cax(1));
display_tab_comp.caxis_up=uicontrol(display_tab_comp.top_button_group,gui_fmt.edtStyle,'position',pos{2,second_group_start+ii}{2},'string',cax(2));
ii =ii+1;

uicontrol(display_tab_comp.top_button_group,gui_fmt.txtStyle,'String','A-Min','Position',pos{1,second_group_start+ii}{1});
uicontrol(display_tab_comp.top_button_group,gui_fmt.txtStyle,'String','A-Max','Position',pos{2,second_group_start+ii}{1});

display_tab_comp.aaxis_down=uicontrol(display_tab_comp.top_button_group,gui_fmt.edtStyle,'position',pos{1,second_group_start+ii}{2},'string',aax(1));
display_tab_comp.aaxis_up=uicontrol(display_tab_comp.top_button_group,gui_fmt.edtStyle,'position',pos{2,second_group_start+ii}{2},'string',aax(2));
ii =ii+1;
...
function change_DispSecFreqs_cback(src,~,~)
curr_disp=get_esp3_prop('curr_disp');
