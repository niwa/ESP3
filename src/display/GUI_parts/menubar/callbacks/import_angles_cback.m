...
trans_obj.Data.replace_sub_data_v2(imresize(acrossangle_new,size(acrossangle_ori),'nearest'),'acrossangle');
trans_obj.Data.replace_sub_data_v2(imresize(alongangle_new,size(acrossangle_ori),'nearest'),'alongangle');
